    ...
    <div class="mb-1">
        ...
        <div class="form-check">
            ...
            <label class="form-check-label active" for="dropdownCheck">
                <input name='menuCandies' value=1 type="checkbox" class="form-check-input" id="dropdownCheck" checked="checked">Candies
            </label>
            @else
        ...
        <div class="form-check">
            ...
            @if( $menu['meal'] == 1)
            <label class="form-check-label active" for="dropdownCheck">
                <input name='menuMeals' value=1 type="checkbox" class="form-check-input" id="dropdownCheck" checked="checked">Meals
            </label>
            @else
        ...
        <div class="form-check">
            ...
            @if( $menu['vegan'] == 1)
            <label class="form-check-label active" for="dropdownCheck">
                <input name='menuDrinks' value=1 type="checkbox" class="form-check-input" id="dropdownCheck" checked="checked">drinks
            </label>
            @else
